...
const LoaderConfirmModal = ({
      ...
      case "chat":
        return (
          <svg
            ...
            className="w-3.5 h-3.5 fill-primary-text"
          >
      ...
      case "view":
        return (
          <svg
            ...
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
            className="w-3 h-3 fill-primary-text"
          >
  ...
  return (
    ...
    >
      <div
        className="relative w-full max-w-md bg-dropdown-bg rounded-md"
        ref={modalRef}
        ...
        <div className="flex flex-col justify-between h-full space-y-4 border rounded-md border-dropdown-border min-h-48">
          <div className="flex flex-col space-y-4">
            <div className="relative flex items-center justify-between px-4 py-2 text-base font-medium border-b text-dropdown-text border-dropdown-border">
              ...
              <button
                className="flex items-center justify-center w-6 h-6 rounded-full cursor-pointer bg-background disabled:bg-btn-primary-disable disabled:text-btn-primary-disable-text"
          ...
          <div className="flex items-center justify-end w-full px-2 py-2 space-x-4 border-t border-dropdown-border">
            ...
            <div className="flex items-center space-x-4">
              {secondaryBtn && (
                <button
                  type="button"
                  className="flex items-center justify-center h-8 px-3 space-x-2 text-xs font-semibold tracking-wide border rounded-md w-fit text-btn-primary-outline-text hover:text-btn-primary-text group border-btn-primary-outline hover:bg-btn-primary-outline-bg disabled:bg-btn-primary-disable disabled:text-btn-primary-disable-text"
              ...
              {primaryBtn && (
                <button
                  type="button"
                  className="flex items-center justify-center h-8 px-3 gap-x-2 text-xs font-semibold tracking-wide rounded-md text-btn-primary-text hover:bg-btn-primary-hover bg-btn-primary disabled:bg-btn-primary-disable disabled:text-btn-primary-disable-text"
...
export default LoaderConfirmModal;

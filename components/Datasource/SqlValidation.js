...
const SqlValidation = ({
  ...
  const databaseWatch = watch("sql_validator.llm.llm_provider");

  useEffect(() => {
    const databaseData = getValues("sql_validator.llm.llm_provider");
    const llmModel = getValues("sql_validator.llm.llm_model");
  ...
  const handleLLmProvider = (newDatabase) => {
    setCurrentModel("");
    setValue("sql_validator.llm.llm_model", "", {
      shouldValidate: true,
    });

    setDatabase(newDatabase);
    setValue("sql_validator.llm.llm_provider", newDatabase, {
      shouldValidate: true,
    });
  };
  ...
  const handleMaxTokens = (status) => {
    if (status === "increase") {
      setValue("sql_validator.llm.max_tokens", tokens + 1, {
        shouldValidate: true,
      });
  ...
  const handleTrainExample = (status) => {
    if (status === "increase") {
      setValue("sql_validator.example_count", trainExample + 1, {
        shouldValidate: true,
      });
  ...
  const temperature = watch("sql_validator.llm.temperature");
  const topP = watch("sql_validator.llm.top_p");
  const frequencyPenalty = watch("sql_validator.llm.frequency_penalty");
  const presencePenalty = watch("sql_validator.llm.presence_penalty");

  const llmProvider = watch("sql_validator.llm.llm_provider");
  const llmModel = watch("sql_validator.llm.llm_model");
      ...
      <div className="flex flex-col py-4 space-y-4">
        <div className="grid w-full grid-cols-12 gap-3 px-3">
          ...
          <div className="w-full col-span-10 max-w-72">
            {showBtn && database && (
              <Controller
                name="sql_validator.llm.llm_provider"
                control={control}
              ...
              <div className="col-span-12 bg-page">
                <div className="flex flex-col">
                  ...
                  >
                    <div className="grid w-full grid-cols-12 gap-3">
                      ...
                      <div className="w-full col-span-10 max-w-72">
                        {showBtn && database === "openai" && (
                          <Controller
                            name="sql_validator.llm.llm_model"
                            control={control}
                            rules={{ required: "Model selection is required" }}
                            render={({
                              field: { onChange, value, ref },
                        ...
                        <div className="grid w-full grid-cols-12 col-span-12 gap-3">
                          ...
                          <div className="w-full col-span-10 max-w-72">
                            <input
                              ...
                              {...register(
                                "sql_validator.llm.deployment_name",
                                { required: true }
                              )}
                              disabled={update ? !showBtn : false}
                            />
                        ...
                        <div className="grid w-full grid-cols-12 col-span-12 gap-3">
                          ...
                          <div className="w-full col-span-10 max-w-72">
                            <input
                              ...
                              {...register("sql_validator.llm.llm_model", {
                                required: true,
                              })}
                              disabled={update ? !showBtn : false}
                            />
                    ...
                    <RangeSlider
                      name="sql_validator.llm.temperature"
                      label="Temperature"
                      min={0}
                      max={1}
                      step={0.1}
                    ...
                    <RangeSlider
                      name="sql_validator.llm.frequency_penalty"
                    ...
                    <RangeSlider
                      name="sql_validator.llm.presence_penalty"
                      ...
                      <div className="col-span-10">
                        <div className="flex items-center w-full space-x-2 max-w-72">
                          <input
                            ...
                            {...register("sql_validator.llm.max_tokens", {
                              required: true,
                              min: {
                                value: 1,
          ...
          <div className="grid w-full grid-cols-12 gap-3">
            ...
            <div className="col-span-10">
              <input
                ...
                {...register("sql_validator.example_count", {
                  required: true,
                  min: {
                    value: 1,
                    message: "Value must be at least 1",
            ...
            >
              ...
              <div className="col-span-12">
                <div className="flex flex-col space-y-3">
                  ...
                  <Controller
                    name="sql_validator.validation_template.system_instructions"
                    control={control}
                    rules={{
                      required: true,
            ...
            >
              ...
              <div className="col-span-12">
                <div className="flex flex-col space-y-3">
                  ...
                  <Controller
                    name="sql_validator.validation_template.human_instructions"
                    control={control}
                    rules={{
                      required: true,
                      validate: (value, formValues) => {

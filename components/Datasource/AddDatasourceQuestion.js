...
import { useUpdateDatasourceSampleQuestionsMutation } from "@/store/datasource";

const AddDatasourceQuestion = ({
  createQuestion,
  setCreateQuestion,
  refetch = () => {},
  update = false,
  ...
  const [updateDatasourceSampleQuestions, { isLoading: updateLoading }] =
  ...
  const handleUpdate = () => {
    ...
    updateDatasourceSampleQuestions({
...
export default AddDatasourceQuestion;

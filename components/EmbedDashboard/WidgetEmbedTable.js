...
import { useGetEmbededWidgetDataQuery } from "@/store/embed";

const WidgetEmbedTable = ({ dashboard_id, section_id, widget_id }) => {
  ...
  const { data, error, isLoading, isFetching } = useGetEmbededWidgetDataQuery({
...
export default WidgetEmbedTable;

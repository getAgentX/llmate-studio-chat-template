...
const DatasourceResponse = ({ data = {}, eventStats = {}, slug = null }) => {
  ...
  const handleShowMore = () => {
    ...
    if (
      ...
      eventStats?.generation_execution?.dataframe !== null
    ) {
    ...
    if (
      ...
      eventStats?.regenerate_execution?.dataframe !== null
    ) {
            ...
            {currentTab === "dataframe" && Object.keys(data).length > 0 && (
              <div className="flex flex-col w-full space-y-4">
                <div className="flex flex-col w-full overflow-x-auto recent__bar">
                  ...
                  {eventStats?.generation_execution?.is_data_too_large && (
                  ...
                  {eventStats?.regenerate_execution?.is_data_too_large && (
                    <div className="flex flex-col py-2 space-y-1 text-xs font-normal">
                      <span className="text-white">
                        Incomplete data is displayed.
                      </span>
            ...
            {currentTab === "sql-response" && (
              <div className="flex flex-col w-full space-y-6">
                <div className="flex items-center justify-between">
                  ...
                  >
                    <div className="cursor-pointer w-full bg-primary rounded-md">
                      <div
                    ...
                    {toggleResponse && (
                      <ul
                        className="flex flex-col w-full bg-[#30333C] rounded-md z-10 divide-y-2 divide-[#2D3035] absolute top-[110%] left-0"
                        ref={modalRef}
                      >
                        {eventStats.validation?.steps_followed.length > 0 && (
                          <li
                            className="py-2.5 px-2 flex items-center justify-between hover:bg-[#3c3e42] text-sm font-medium cursor-pointer text-white bg-primary"
                            onClick={() => {
                              setCurrentResponse("summary");
                              setToggleResponse(false);
                            }}
                  ...
                  <div className="flex flex-col space-y-4">
                    {eventStats.validation?.steps_followed.length > 0 && (
                      <div className="flex flex-col space-y-4">
                        ...
                        <ul className="flex flex-col p-4 space-y-2 border rounded-md border-[#32363E] max-h-[400px] h-full recent__bar overflow-y-auto">

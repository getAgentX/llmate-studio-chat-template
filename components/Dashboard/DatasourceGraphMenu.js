...
const DatasourceGraphMenu = ({
  ...
  const [
    ...
    { isLoading: saveChangeLoading },
  ] = useUpdateDatasourceVisualizationConfigMutation();

  // const { data, error, isFetching } = useGetDataGraphQuery({
  ...
  const { data, error, isFetching } = useGetGraphForQuery(
    {
      datasource_id: datasourceId,
      run_id: runId,
      event_id: eventId,
            ...
            >
              {saveChangeLoading && (
                <div role="status">
                  <svg
                    aria-hidden="true"
                    className="w-4 h-4 animate-spin text-primary-text fill-[#295EF4]"
                    viewBox="0 0 100 101"
                    fill="none"
                    xmlns="http://www.w3.org/2000/svg"
                  >
          ...
          <div className="flex flex-1 h-full px-2 pb-1 overflow-hidden">
            <div className="flex-1">
              <div className="grid w-full h-full max-h-full grid-cols-12 rounded-md bg-primary">
                <div className="col-span-7 overflow-y-auto border-r recent__bar border-border-color">
                  <div className="relative flex flex-col h-full max-h-full">
                    <div className="flex sticky px-4 pt-3 pb-2.5 top-0 left-0 z-[100] text-xs text-primary-text capitalize font-medium justify-between rounded-tl-md rounded-tr-md w-full border-b border-border-color bg-primary-bg">
                      Preview
                    </div>
                      ...
                      <div className="h-full max-h-full p-2">
                        {isConfigEmpty(visualizationConfig) || (
                          <div className="relative w-full h-full">
                            {isLoading && (
                              <div className="flex items-center justify-center w-full h-full min-h-full rounded-md text-primary-text bg-page">
                                <div role="status">
                                  <svg
                                    aria-hidden="true"
                          ...
                          <div className="flex items-center justify-center w-full h-full">
                            <span className="flex items-center justify-center">
                              <svg
                                ...
                                fill="none"
                                xmlns="http://www.w3.org/2000/svg"
                                className="w-10 h-10 fill-secondary-text"
                              >
                                <path d="M10.6667 37.3333H16V18.6667H10.6667V37.3333ZM21.3333 37.3333H26.6667V10.6667H21.3333V37.3333ZM32 37.3333H37.3333V26.6667H32V37.3333ZM5.33333 48C3.86667 48 2.61111 47.4778 1.56667 46.4333C0.522222 45.3889 0 44.1333 0 42.6667V5.33333C0 3.86667 0.522222 2.61111 1.56667 1.56667C2.61111 0.522222 3.86667 0 5.33333 0H42.6667C44.1333 0 45.3889 0.522222 46.4333 1.56667C47.4778 2.61111 48 3.86667 48 5.33333V42.6667C48 44.1333 47.4778 45.3889 46.4333 46.4333C45.3889 47.4778 44.1333 48 42.6667 48H5.33333ZM5.33333 42.6667H42.6667V5.33333H5.33333V42.6667Z" />
                              </svg>
                            </span>
                ...
                <div className="col-span-5 overflow-hidden">
                  <div className="flex flex-col h-full max-h-full space-y-2">
                    <div className="flex items-center sticky top-0 left-0 z-[100] bg-primary justify-between px-4 pt-3 pb-2.5 border-b border-border-color">
...
export default DatasourceGraphMenu;
